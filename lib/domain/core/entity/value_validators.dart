import 'package:crave_app/domain/core/utils/common_util.dart';
...
class ValueValidators {
  ...
  static Either<ValueFailure<String>, String> validatePassword(String input) {
    if (input.length <= 6 && CommonUtils.validatePassword(input)) {
      return right(input);
    } else {
  ...
  static Either<ValueFailure<String>, String> validateRetypePassword(
